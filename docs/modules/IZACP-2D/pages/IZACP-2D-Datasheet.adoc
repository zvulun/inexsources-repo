:docproductname: IZACP-2D
:shortprodname: IZACP-2D
:generic-product-name: Two-Door Access Control Panel
...
*_\{Need hi-res pictures - asked Kaylee}_*
...
* [*] Recognizes QR code, PIN input and RFID card
