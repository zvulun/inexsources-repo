...
* Chrome *_\{don't tell them this - they will have to pay $19/yr}_*
You can add an IE Tab extension to Chrome at this link (to enable access to the Flexwatch sensor configuration application):
https://chrome.google.com/webstore/detail/ie-tab/hehijbfgiekmjfkfjpbkbammjbdenadd[link, window=_blank]
...
.. Username/Password is admin/IZpass12
