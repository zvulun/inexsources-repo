...
=============================
Your IT team must enable you to access the IP
...
== Using Daily Reports (Received via Email)
...
Reports are sent every day, via email as an Excel
attachment. They contain events from last 24 hours
