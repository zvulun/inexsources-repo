...
*_\{put table of cameras and IP/ports
station, camera 1 with new line with URL linked, camera 2 same;
not hadassah}_*

*_\{Make IMPORTANT note that IT team must enable you to
access IP and ports of the cameras}_*
...
. Enter the username and password provided by {companyname-short}:
...
*_\{explain parts of screen; put
the explaation of zoom, etc, with
a picture of the zoom result
in  the zoom section}_*
...
*_\{put somewhere - system stores
4 months of video back}_*

*_\{in first pane, File Type must be left as dav}_*
...
== Using Roadview to View Events *_\{TBD}_*
An Event is a train that enters or leaves a station.

*_\{no access to RoadView; instead explain
report that comes every 24 hrs via email
show example and a few explanations}_*
