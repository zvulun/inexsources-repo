...
image::./UserGuide/image1.png[image,width=532,height=229]
...
image::./UserGuide/image2.png[image,width=538,height=494]
...
[width="100%",cols="20%,26%,16%,17%,21%",options="header",]
|===
|Item | |Specification | |
...
|Integrated Cameras |{compname-short} Cameras |{camera-6F}, IZB600F | |
| |3rd party cameras |Any camera which supports the RTSP streaming protocol and H.264 encoding can be integrated with this AI Data Processing Unit | |
|Processing Power |Processing Power (fps) |40 | |
|Number of Cameras Supported |Triggering Modes: a|*Triggered* a|*Non-Triggered* a|*On Demand*
| |< 20 mph (32 km/h) |8 |4 |4
| |20-40 mph (32-64 km/h) |8 |2 |2
| |40-80 mph (64-128 km/h) |8 |1 |1
|Video Input |Streaming Protocol |RTSP | |
| |Video Compression |H.264 | |
| |Video Resolution |Up to 3 MP | |
|Supported Protocols (for additional protocols, see the https://drive.google.com/drive/folders/1Hz1mXjDo4MDDwlEiBVigyxUnc1ZEsEX8?usp=share_link[{software-ALPR} documentation]) |{compname-short} HTTP API |LPR Events are reported via protocols such as the {compname-short} HTTP API protocol. Each LPR Event includes metadata and associated images. | |
...
| |System and Data Storage |250 Gb | |
|Environmental |Operating Temperature |32°F to 113°F (0°C to 45°C); 0.2-0.3m/s air flow; according to GB/T 2423-2008 | |
| |Storage Temperature |-13°F to {plus}176°F (-25°C to {plus}80°C) | |
| |Humidity |10% - 90% RH, non-condensing | |
| |Vibration |1 Grms,10Hz~150Hz, 3 Axis; +
according to GB/T 2423.10-2008 | |
| |ESD |Touch 4KV, Air 8KV; +
according to IEC 61000-4-2, Level 3 | |
| |TVS |1 KV | |
|Certifications |EMC |EN 55032:2015{plus}A11:2020, EN 55035:2017{plus}A11:2020, EN IEC 61000-3-2:2019, EN 61000-3-3:2013{plus}A1:2019 | |
| |RoHS |EU RoHS Directive 2011/65/EU and its amendment directi{system-type} 2015/863/EU (RoHS 2.0) | |
| |NDAA |NDAA Section 889 compliant | |
|Physical |Dimensions (W x H x D) |4.33" x 2.52" x 2.52" (110 x 64 x 64 mm) | |
| |Weight |1.05 lbs (475 g) | |
| |Color |Black | |
|Interface |Various |See Interface section | |
|Power |Input |12 VDC | |
| |Typical Power Consumption |18 Watts | |
|Accessories |Accessories Included |12 VDC power adapter | |
|===
...
image::./UserGuide/image3.png[image,width=482,height=159]
...
image::./UserGuide/image4.png[image,width=197,height=197]
...
image::./UserGuide/image5.png[image,width=487,height=150]
...
* Network surge protector/arrestor on all network cables (see <<s_Installation-Considerations>>)
...
** Chrome or Edge browser version

[#s_Installation-Considerations]
...
image::./UserGuide/image6.png[image,width=301,height=210]

[#f_LAN-Cable-Shield-Wire-Soldered-to-Connector-Body]

.LAN Cable: Shield Wire Soldered to Connector Body

image::./UserGuide/image7.png[image,width=259,height=193]

[#s_Connecting-the-IZIDPUG-Cameras-Network-Switch-External-System-and-Network]

=== Connecting the {shortprodname}, Cameras, Network Switch, External System and Network
...
image::./UserGuide/image8.png[image,width=563,height=209]
...
[#f_Conecting-a-Laptop]

.Conecting a Laptop

image::./UserGuide/image9.png[image,width=313,height=195]

Connect your laptop to the same network switch the {shortprodname} is connected to.
