...
=== Illinois State Toll Highway Authority {empty} image:ISTHA-Logo.png[image,width=60,align=left]
*_/{Reword these/reduce them - and find out the exact
conditions of each metric}_*

* Total length of roads - per lane, per direction?

* Number of cameras

* Transactions per year - per each passage on gantry, or per total trip?

* How much revenue from tolls - per year

=== New York State Thruway {empty} image:NYSTA-Logo.png[image,width=70,align=left]

=== Virginia Department of Transportation {empty} image:VDOT-Logo.png[image,width=130,align=left]

=== Ohio Turnpike {empty} image:OHIO-Logo.png[image,width=40,align=left]

=== Singapore Land Transportation Authority, ERP2 {empty} image:LTA-Logo.png[image,width=150,align=left]

=== Ministry of Transport of Vietnam {empty} image:VIETNAM-Logo.png[image,width=45,align=left]

=== Puerto Rico Highways and Transportation Authority {empty} image:PUERTORICO-Logo.png[image,width=40,align=left]
