...
* [*] <<s_Prepare-Components-and-Tools,Prepare components and tools>>

* [*] <<s_Plan-Your-Site,Plan your site>>

ifndef::xref-type-IZ600F[]
* [*] <<s_Mounting-the-Camera-System,Install Camera System(s) and other components>>
endif::[]

ifdef::xref-type-IZ600F[]
* [*] <<s_Mounting-the-Camera-System,Install camera(s) and other components>>
endif::[]

* [*] <<s_Connect-Components-Wiring,Connect components (wiring)>>

* [*] <<s_Power-Up-and-Set-Up-IP,Power up and set up IP>>

* [*] <<s_Configuring-a-Camera,Configure LPR/OV camera settings>>

* [*] <<s_Aim-and-Calibrate,Aim and calibrate>>
