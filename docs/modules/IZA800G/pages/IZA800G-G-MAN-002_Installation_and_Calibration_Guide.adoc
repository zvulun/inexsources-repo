...
|1.71 |July 23, 2023 a|* Removed references to Video Analytics Data Sheet from Related Documents and spec. tables; made reference to {software-ALPR} documentation generic
