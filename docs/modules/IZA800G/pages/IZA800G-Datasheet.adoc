...
|===
|Part Number |Description (S/L - motorized zoom and auto-focus; XL - manual zoom and focus)
|{shortprodname}-S-DR |5-35 ft (2-11 m) range, Deep Red illumination, 24 VDC input voltage
|{shortprodname}-S-DR-CAB15F |5-35 ft (2-11 m) range, Deep Red illumination, 15 ft cable set, 24 VDC input voltage
...
|{shortprodname}-S-IR-P48 |5-35 ft (2-11 m) range, Infrared illumination, PoE{plus}, 48 VDC input voltage
|{shortprodname}-S-IRW |5-35 ft (2-11 m) range, Infrared &amp; Visible Light illumination, 24 VDC input voltage
|{shortprodname}-S-IRW-P48 |5-35 ft (2-11 m) range, Infrared &amp; Visible Light illumination, PoE{plus}, 48 VDC input voltage
