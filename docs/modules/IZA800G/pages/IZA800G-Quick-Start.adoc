...
Scan this code for full documentation and software:

[sidebar]
You will need: Laptop with Windows 10 or above; Windows Feature NET 4.5 enabled, IE 11 or higher+++<br>+++
After mounting, remove the protective film from the camera's front window. You can use IZ Discovery to find the desired camera and change its network settings
