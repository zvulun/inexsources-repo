...
.^| xref:Mounts:MOUNT-MAP-PRSNT-011_ProductToMountMapping.adoc[MOUNT-MAP-PRSNT-011,window=read-later]
.^| Product-to-Mount Mapping

.^| xref:Mounts:MOUNT-MAP-PRSNT-011_ProductToMountMapping.adoc[Mounts,window=read-later]
...
|Mounting Hardware (pan-tilt-roll bracket) |Typically on gantry or wall/pole; see the xref:Mounts:MOUNT-MAP-PRSNT-011_ProductToMountMapping.adoc[Mounting Hardware Documentation,window=read-later] for details.
|===
...
Secure the Camera System to the appropriate mounting hardware (see the xref:Mounts:MOUNT-MAP-PRSNT-011_ProductToMountMapping.adoc[Mounting Hardware Documentation,window=read-later]).
