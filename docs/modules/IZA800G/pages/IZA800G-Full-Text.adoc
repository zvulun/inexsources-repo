...
include::ROOT:partial$p-izdiscovery-sec1.adoc[First part of IZ Discovery text]

[#s_Changing-a-Device-s-IP-Address-and-Network-Settings]

=== Changing a Device's IP Address and Network Settings

include::ROOT:partial$p-izdiscovery-sec2.adoc[Second part of IZ Discovery text]
