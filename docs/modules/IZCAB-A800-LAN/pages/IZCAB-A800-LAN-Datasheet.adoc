...
include::IZCAB-A800-LAN:IZCAB-A800-LAN-spec-table.adoc[IZCAB-A800-LAN Spec Table]
...
|{shortprodname}-15F |LAN Cable for IZA800G System, 15 ft
|{shortprodname}-30F |LAN Cable for IZA800G System, 30 ft
|===
