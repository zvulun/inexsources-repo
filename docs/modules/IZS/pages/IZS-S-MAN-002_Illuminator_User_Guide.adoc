...
[discrete]
== {shortprodname} Strobe Illuminator Series
[discrete]
=== User Guide
...
* *Technical personnel* who need to install {compname-short} illuminators.
...
|===
|Doc. No. |Title
|{camera-8G}-G-MAN-002a |{camera-8G} User Guide
|{camera-8G}-G-MAN-002b |{camera-8G} Installation Guide
|{camera-8G}-G-xx-TDSHEET |{camera-8G} Technical Data Sheet
|{camera-8G}-G-TECH-001 |{camera-8G} Quick Start
|MOUNT-MAP-PRSNT-011 |Product-to-Mount Mapping
|MOUNT-IZSL-PRSNT-004 |Illuminator Mounting - U.S.A.
|MOUNT-IZSL-PRSNT-005 |Illuminator Gantry Mounting - Using Packaged Hardware
|IZPWR-SRFC-MAN-001 |IZPWR Surface Mount Power Supplies User Guide
|IZPWR-DIN-MAN-002 |IZPWR DIN Rail Mount Power Supplies User Guide
...
|===
|Item |Notes
|24 VDC power supply (voltage-adjustable) |{compname-med} IZPWR 24 VDC power supply models. It is recommended to use an illuminator power supply separate from the Camera System's supply.
|===
...
See the appropriate Camera Installation and Configuration Guide(s) for an explanation of the model number codes (effective distances, and wavelengths/number of LEDs). *_\{Add {camera-5G} or GR here – since new pinout should allow for a strobe trigger as in the Driver Face Capture solution – and fix in catalog as well\}_*

[#t_Camera-to-Illuminator-Typical-Use-Cases]

.Camera-to-Illuminator Typical Use Cases

[width="100%",cols="30%,19%,19%,15%,17%",options="header",]
|===
|Camera |Illuminator |Strobe Signal |Night Image |Installation
|{camera-8G}-L/XL-xx |{shortprodname}2-WL-20 |OV Strobe |Color |Rear
|{camera-8G}-S-xx |{shortprodname}1-WL-H40 +
{shortprodname}1-WL-30 | | |
|{camera-8G}-L/XL-xx |{shortprodname}2-IR-20 |OV Strobe |B/W |Front
|{camera-8G}-S-xx |{shortprodname}1-IR-H40 +
{shortprodname}1-IR-30 | | |
|{camera-GRV} |{shortprodname}2-IR-H120 |RV Strobe |B/W |Side
|{camera-DOT} |{shortprodname}2-IR-H120 |Near Lane (NL) Strobe and Far Lane (FL) Strobe |B/W |Side
...
*+++<u>+++All cable extensions and repeaters must be shielded.+++</u>+++*

a|
* Power - Use a cable gauge sufficient to deliver 24 VDC at the illuminator, depending on the power supply used

* Signals - Use a cable gauge sufficient to deliver the required trigger and RS485 signals at the illuminator.
...
* Mount illuminators at an appropriate distance away from their associated camera(s), according to the objecti{system-type} of your project. Contact {compname-short} for guidance/training about this subject.
...
If you need to add length to the power or signals cables (see <<s_Additional-Installation-Considerations>>), be sure that: the supplied voltage (24 VDC) reaches the illuminator, the trigger signal levels you need reach the illuminator, and the RS485 signal levels reach the illuminator
...
image::./UserGuide/image11.png[image,width=507,height=316]

*_\{Need to relink all P/Ns in this table to the proper AsciiDoc locations\}_*

[width="100%",cols="12%,51%,37%",options="header",]
|===
|Item |Description |Ordering Information
|A a|*LAN Cable for {camera-8G} System* |{compname-short} P/N: IZCAB-A800-LAN
|B a|*Power/Signals Cable for {camera-8G} System* |{compname-short} P/N: IZCAB-A800-PAS
|C a|*Power Supplies:* 24 VDC, 100/120W; DIN rail mount option +
+
Can power 2 cameras from a single power supply |{compname-short} P/N: IZPWR120-24-MWL-DIN
|D a|*Illuminator Power Cable* |Included; {compname-short} P/N: IZCAB-SPWR-15F
|E a|*Illuminator Signals Cable* |Included; {compname-short} P/N: IZCAB-SSIG-15F
|F a|*{shortprodname} Strobe Illuminator* |{compname-short} P/N: (See <<t_Camera-to-Illuminator-Typical-Use-Cases>> for Camera-to-Illuminator Typical Use Cases)
|===
...
Doc. No. {shortprodname}-S-MAN-002a
