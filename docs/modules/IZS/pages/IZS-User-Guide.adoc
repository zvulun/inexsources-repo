...
.^|xref:IZCAB-SPWR:DocList.adoc[IZCAB-SPWR-REV-A-TDSHEET] |Power Cable for {illum-strobe} Illuminators Technical Data Sheet
.^|xref:IZCAB-SSIG:DocList.adoc[IZCAB-SSIG-REV-A-TDSHEET] |Signals Cable for {illum-strobe} Illuminators Technical Data Sheet
...
* Power cable, 15 ft (4.6 m); different
xref:IZCAB-SPWR:DocList.adoc[IZCAB-SPWR] cable lengths
can be ordered

* Signals cable, 15 ft (4.6 m); different
xref:IZCAB-SSIG:DocList.adoc[IZCAB-SSIG] cable lengths
can be ordered
...
image::ROOT:IZS/IZS-S-FIG-004b_NEW_S3_Dimensions.png[image,width=626,height=336]
...
//.Front {camera-ORT} with Illuminator Wiring Diagram (Infrared Light)

//image::ROOT:IZA800GORT/IZA800GORT-FIG-034f_USA_IllumLPRFront.png[image,width=580]

//{empty} +
//{empty}

//.Rear {camera-ORT} with Illuminator Wiring Diagram (White Light)

//image::ROOT:IZA800GORT/IZA800GORT-FIG-034f2_USA_IllumOVRear.png[image,width=580]

//<<<

//.Front or Rear {camera-8G} with Illuminator Wiring Diagram

//image::ROOT:IZS/IZS-S-FIG-013c_OV_Triggered_Wiring.png[image,width=580]
