...
.^|xref:IZCAB-SPWR:DocList.adoc[IZCAB-SPWR-REV-A-TDSHEET] |Power Cable for IZS Illuminators Technical Data Sheet
.^|xref:IZCAB-SSIG:DocList.adoc[IZCAB-SSIG-REV-A-TDSHEET] |Signals Cable for IZS Illuminators Technical Data Sheet
