...
wiring for front/rear capture - see the following Figures!*
...
image::ROOT:IZA800GORT/IZA800GORT-FIG-034f_USA_IllumLPRFront.png[image,width=550]

.Rear {camera-ORT} with Illuminator Wiring Diagram (White Light)

image::ROOT:IZA800GORT/IZA800GORT-FIG-034f2_USA_IllumOVRear.png[image,width=550]

<<<

.Front or Rear {camera-8G} with Illuminator Wiring Diagram

image::ROOT:IZS/IZS-S-FIG-013c_OV_Triggered_Wiring.png[image,width=550]
