...
\{This image is an example of reuse from another doc's images - this is the IZA500G image}

Using only one colon after an image specification enables an inline image:ROOT:image$ROHS_LOGO.png[ROHS Logo,width=150,align="left"] image.
