= IZA800G
// This is supposed to affect all the tables on this page
...
== Installation
Here is an include from the partial of the installation intro that is in this same ROOT/partials folder; note how by defining the productname variable (with a colon before and after) with the product name of this page, you will see it in the partial which uses the same variable name in curly brackets:
