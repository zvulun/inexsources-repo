...
include::ROOT:p-regulatory-header.adoc[Regulatory Notices Header]

include::ROOT:p-regulatory-FCC.adoc[FCC Regulatory Notice]

include::ROOT:p-regulatory-CE-ROHS.adoc[EU-CE-ROHS Regulatory Notice]
