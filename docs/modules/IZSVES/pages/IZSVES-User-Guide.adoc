...
a|
* Power - Use a cable length sufficient to deliver 24 VDC at the illuminator, depending on the power supply used

* Signals - Use a cable length sufficient to deliver the required strobe and RS485 signals at the illuminator.
...
========================================
If you need to add length to use a longer illuminator
cable
