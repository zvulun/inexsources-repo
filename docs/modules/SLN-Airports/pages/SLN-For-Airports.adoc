...
* [*] Vehicle security alerts from license plate blacklists
...
Real-time people tracking systems can alert security personnel
...
image:AirportPopulationCount.png[image,width=300,align=left] {empty} image:Crowding.jpg[image,width=300,align=left]
...
<.^a|* +++<font size="+1">+++San Jose, CA +++</font>+++ {empty} image:Airport-SanJose.png[image,width=75,align=left]
<.^a|* +++<font size="+1">+++San Diego, CA +++</font>+++ {empty} image:Airport-SanDiego.png[image,width=50,align=left]
...
[width="100%",cols="50%,50%",frame="none",grid="none"]
|===
a| https://www.inextechnologies.com/[www.inextechnologies.com, window=_blank]
a| {empty}
a|+++<font size="-1">+++ USA Headquarters: +
