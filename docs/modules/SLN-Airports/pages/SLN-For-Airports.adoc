...
|===
<.^a|* +++<font size="+1">+++Ben Gurion Airport, Israel +++</font>+++ {empty}image:Airport-Vietnam.png[image,width=100,align=left] <.^a|* +++<font size="+1">+++Ben Gurion Airport, Israel +++</font>+++ {empty}image:Airport-Vietnam.png[image,width=100,align=left]
