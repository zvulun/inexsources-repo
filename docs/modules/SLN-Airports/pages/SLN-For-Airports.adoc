...
>.^a|+++<font size="+1">+++Ben Gurion Airport, Israel +++</font>+++ <.^a|image:Airport-Ben-Gurion.png[image,width=250,align=left] >.^a|+++<font size="+1">+++Ho Chi Minh City (HCMC) Airport(TIA), Vietnam+++</font>+++ <.^a|image:Airport-Vietnam.png[image,width=50,align=left]
