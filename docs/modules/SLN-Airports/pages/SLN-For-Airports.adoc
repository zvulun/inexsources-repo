...
|===
>.^a|+++<font size="+1">+++Austin-Bergstrom, TX +++</font>+++ <.^a|image:Airport-Austin-Bergstrom.png[image,width=300,align=left] >.^a|+++<font size="+1">+++Omaha, NB +++</font>+++ <.^a|image::Airport-Omaha.png[image,width=50,align=left]
|===
