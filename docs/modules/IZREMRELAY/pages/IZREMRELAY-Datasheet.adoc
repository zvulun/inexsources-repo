...
.^a|* {docproductname}-I
* {docproductname}-E .^a|Single Relay Remote (Web) Relay
.^a|* {docproductname}-4-I
* {docproductname}-4-E .^a|Quad Relay Remote (Web) Relay
|===

+++*+++ Power inputs: "I" models:
9-28 VDC;
"E" models: PoE and/or 9-28 VDC
