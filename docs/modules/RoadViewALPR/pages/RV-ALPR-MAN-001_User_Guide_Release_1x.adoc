...
must be supported in the list of validation criteria patterns, or "plate type" (set by {compname-short}).
...
variations. If one of the conditions is not met, this
indicates an error in the LPR or State read. The initial
