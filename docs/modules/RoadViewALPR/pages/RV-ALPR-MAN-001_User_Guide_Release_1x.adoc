...
must be supported in the list of validation criteria patterns, called a "plate type" (set by {compname-short}).
...
variations. If the Region is supported, but there was no match with one of the validation patterns,
