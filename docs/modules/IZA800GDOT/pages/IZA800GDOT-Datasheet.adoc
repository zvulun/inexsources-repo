:docproductname: IZA800GDOT
:shortprodname: IZA800GDOT
:generic-camera-name: USDOT Number Recognition All-in-one AI Camera System
...
[discrete]
== USDOT Number Recognition All-in-one AI Camera System
...
image:ROOT:IZA800GDOT/IZA800GDOT-FIG-006_NewFrontPage.png[Picture of Camera,400,align=left]
...
* [*] Dual sensor provides multiple lane coverage for USDOT number reads
...
include::ROOT:partial$/IZA800GDOT/p-IZA800GDOT-spec-table.adoc[IZA800GDOT Spec table]
...
|{shortprodname} | USDOT Number Recognition All-in-one AI Camera System
|===
...
image::ROOT:IZA800GDOT/IZA800GDOT-FIG-004_Front_Dimension_View.png[image,width=315,height=205]
...
include::ROOT:partial$IZA800GDOT/p-IZA800GDOT-connector-pinouts.adoc[IZA800GDOT Connector Pinouts]

[discrete]
== Camera-to-Illuminator Recommended Setups

include::ROOT:partial$IZA800GDOT/p-IZA800GDOT-illum-tbl.adoc[Camera to Illuminator Setups]
