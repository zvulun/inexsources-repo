...
.^|J .^a|*{illum-non-strobe} Illuminator* .^|{compname-short} P/N: See the xref:IZL:DocList.adoc[{illum-non-strobe} Illuminator User Guide] for a table of Camera-to-Illuminator Typical Use Cases
|===
