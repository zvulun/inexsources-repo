. When you see a vehicle at a typical plate capture position on the video, click on the video to pause it.
...
Wait several seconds for the display to refresh
automatically, which indicates that the
{software-ALPR} recognition software
