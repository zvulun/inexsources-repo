...
.^a| * 3-wire power cable, shielded with a polyethylene jacket; ends terminated with metal rings



.^a| * Digital input (trigger) signal wires and relay output connections (see next items)
...
.^a| * Trigger Wet: Green ({plus}5-12 V), Blue (GND)
