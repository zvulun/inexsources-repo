...
.^a| * No model suffix: 12-24 VDC {plus}/- 10%, Class 2 Low-Voltage
* With P48 model suffix: 48 VDC {plus}/- 10%, Class 2 Low-Voltage or PoE+
...
+++**+++ The IZ4POE is required for the PoE+ input power option