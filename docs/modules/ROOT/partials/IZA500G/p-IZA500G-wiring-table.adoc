...
a|
For 1 camera, use a 50/75W supply (DIN Rail mount) +
For 2 cameras, use a 100/120W supply (DIN Rail/Surface mount) +
For 4 cameras, use a 240W supply (DIN Rail mount) +
...
Requires 48 VDC
a|
For 1 camera, use a 50W supply (DIN Rail mount) +
For 2 cameras, use a 120W supply (DIN Rail mount) +
For 4 cameras, use a 240W supply (DIN Rail mount)
|===
