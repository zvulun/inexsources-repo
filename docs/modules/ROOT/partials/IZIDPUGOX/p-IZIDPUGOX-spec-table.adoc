...
+++*+++ *_\{may need to re-measure without bracket?
and what about dimensions with DIN rail adapter attached?}_*Height measurement includes wall mount
bracket; width does not include bracket