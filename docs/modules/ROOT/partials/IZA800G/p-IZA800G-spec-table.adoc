...
.^| LAN Cable for {shortprodname} System (xref:IZCAB-A800-LAN:DocList.adoc[IZCAB-A800-LAN]) - different lengths
...
+++**+++ For part numbers {shortprodname}-XX-XX +
+++***+++ For part numbers {shortprodname}-XX-XX-CAB15F