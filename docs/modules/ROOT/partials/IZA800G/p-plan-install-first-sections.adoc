...
========================================
See your camera's data sheet
for capture distance
specifications.

Installations that position the
camera at significant angles in
relation to the plates will reduce
the line-of-sight distances specified.
