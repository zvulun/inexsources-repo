...
ifndef::xref-type-IZ600F[==== Matching Your Camera System to an {compname-short} Illuminator]
ifdef::xref-type-IZ600F[==== Matching Your Camera to an {compname-short} Illuminator]
...
By using the following guidelines, you can match the illuminator to your {compname-short}
