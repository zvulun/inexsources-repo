...
* Do not disassemble the {generic-camera-name} or external illuminator units. Repair or replacement of parts for this {generic-camera-name} and its external illuminator units should be supplied by INEX Technologies, and installed by qualified service personnel.
* Handle and store the {generic-camera-name} and external illuminator units with care.
