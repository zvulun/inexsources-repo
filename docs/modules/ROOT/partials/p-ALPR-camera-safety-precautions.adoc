...
ifdef::xref-type-IZA800G,xref-type-IZA800GVES,xref-type-IZA500G[* Do not disassemble the {generic-camera-name} or external illuminator units.]
ifndef::xref-type-IZA800G,xref-type-IZA800GVES,xref-type-IZA500G[* Do not disassemble the {generic-camera-name}.]
Repair or replacement of parts for this {generic-camera-name}
ifdef::xref-type-IZA800G,xref-type-IZA800GVES,xref-type-IZA500G[and its external illuminator units ]
should be supplied by {compname-long}, and installed by qualified service personnel.
* Handle and store the {generic-camera-name}
ifdef::xref-type-IZA800G,xref-type-IZA800GVES,xref-type-IZA500G[and external illuminator units ]
with care.
