...
** Set the Margins to Custom; all margins should be at their defaults (0.5")
*** If so, set the Margins to Default
*** If not, click in each  margin number box on
the page display, and set it to 0.5"
