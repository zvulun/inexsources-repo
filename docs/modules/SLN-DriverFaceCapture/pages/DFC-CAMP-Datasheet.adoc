...
image:ROOT:SLN-DriverFaceCapture/DFC-CAMP-Face-Woman-Front.png[Picture of Face in Front Windsh,400,align=left]
...
|{shortprodname}-S-DR-P48 |5-35 ft (2-11 m) range, Deep Red illumination, PoE{plus}, 48 VDC input voltage
|{shortprodname}-S-DRW |5-35 ft (2-11 m) range, Deep Red &amp; Visible Light illumination, 24 VDC input voltage
|{shortprodname}-S-DRW-P48 |5-35 ft (2-11 m) range, Deep Red &amp; Visible Light illumination, PoE{plus}, 48 VDC input voltage
