...
[sidebar]
If you are using a DIN rail-mount power supply, you will need to cut off the rings at the ends of the Camera System's power connections, and attach pins in their place. +++<br>+++
+++<br>+++
