...
== Installation
Here is an include from the partial of the installation intro that was in IZA800G partials:
include::inexsources-repo:IZA800G-user-guide:partial$prtl-install-intro.adoc[] 
