...
|https://drive.google.com/drive/folders/1DVDBey9z7SnCF88wLhboAhjOkmoHQrfU?usp=sharing[{shortprodname}-TECH-003] |{shortprodname} Quick Start |1.xx
...
|https://drive.google.com/drive/folders/1xoZCcRySjtV8UCjKUWQyDaUZjhPrUJbm?usp=sharing[{hw-outdoor-processor}-REV-B1-TDSHEET] |{hw-outdoor-processor} AI Outdoor Data Processing Unit: Technical Data Sheet |Latest
