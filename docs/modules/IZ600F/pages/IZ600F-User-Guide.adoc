...
* A list of accessories that can be supplied by {compname-short} can be found at the end of the Specifications (see <<s_Specifications>>).
...
** Mount illuminators at an appropriate distance away from their associated camera(s), according to the objectives of your project. Contact {compname-short} for guidance/training.
