...
|===
|Doc. No. |Title
|xref:IZ600F:DocList.adoc[{shortprodname}-TECH-003] |{shortprodname} Quick Start
|https://drive.google.com/drive/folders/1DVDBey9z7SnCF88wLhboAhjOkmoHQrfU?usp=sharing[{shortprodname}-REV-x-TDSHEET] |{shortprodname} Technical Data Sheet
