...
user which should be publicized instead.+++</u>+++*
...
you must set the System > Access Level to Limited Access (see <<s_Access-Level>>).
...
RTSP URL syntax, it is recommended not to use this character in the
password.
