...
* A list of accessories that can be supplied by {compname-med} can be found at the end of the Specifications (see your camera's User Guide).
...
* Network (LAN) cabling (typically CAT 5e/6 cable) with *_\{really need metal body?}_* metal-body RJ45 connectors. The total length of the cable should not exceed 328 feet (100 meters). *See <<s_Preparing-the-Cable-Connections>> for important LAN cable information.*
