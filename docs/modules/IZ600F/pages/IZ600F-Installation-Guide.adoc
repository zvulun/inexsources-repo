...
*_\{rename filenames and put in ROOT/images
and partials for reuse; also show
diagram with external power supply?}_*
...
[table.withborders,width="100%",cols="8%,44%,48%",options="header",]
|===
...
ensure that all cameras receive exactly their rated voltage (see your camera's User Guide).
