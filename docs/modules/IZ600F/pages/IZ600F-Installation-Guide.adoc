...
*_\{Why has the Max. Video Encoding dropdown disappeared
from the camera screens?}_*
...
=== Enabling the RTSP Service and Port
...
//and click on the Admin button at the upper left.
