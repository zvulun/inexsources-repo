...
If you add extensions to cables,
...
base so that the notch through which the camera's cable
will pass is pointing down (see <<f_Pan-Tilt-Roll-Angle-Adjustments>>).
=====================================
+
[NOTE]
=====================================
