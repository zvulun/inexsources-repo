...
For {illum-non-strobe}1, use {compname-short} P/N: xref:IZPWR:DocList.adoc[IZPWR120-24-MWL-DIN]

For {illum-non-strobe}2, use {compname-short} P/N: xref:IZPWR:DocList.adoc[IZPWR240-24-MWL-DIN]
