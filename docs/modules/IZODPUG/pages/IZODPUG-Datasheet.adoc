...
* [*] Fanless design for high reliability
...
.^|{shortprodname}-DC-PG .^|Outdoor AI Data Processing Unit
|===

[discrete]
== Standard Package Contents

* {shortprodname}, Outdoor AI Data Processing Unit
...
Doc. No. {shortprodname}-REV-B1-TDSHEET
