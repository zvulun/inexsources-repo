...
*_\{rewrite/improve:
What it does - opens gate uber/lyft or whitelist -
look in cloud - what do you need to set it;
show in cloud; how to find each one; add to whitelist/blacklist
if blacklist there will be alert - }_*
...
{software-cloud} Whitelist.

Vehicles on a Blacklist generate an alert; alerts

*_\{if blacklist - get alert
ask Andrey; also list of events}_*
...
=== {software-cloud} Access Control Lists - Whitelists and Blacklists
...
.{software-cloud} Lists Page

image::ROOT:SLN-GKSYS/RV-GKSYS-FIG-221_IZCloudWatchLists.png[image,800]


.{software-cloud} Whitelist Page
