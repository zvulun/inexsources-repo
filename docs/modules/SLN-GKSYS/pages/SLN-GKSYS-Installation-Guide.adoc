...
*_\{Pinchas: does the LPR Camera Settings screen
have the color-related buttons at the bottom, or was
this just because I used both screens for LPR and OV;
also are the LPR / OV camera settings screens
identical except for the day & night control setting?}_*
