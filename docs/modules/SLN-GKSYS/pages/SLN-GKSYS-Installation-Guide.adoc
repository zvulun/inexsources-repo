...
*_\{The LPR and OV Stream Setup screens did not have these
parameters pre-set; will they be set
in the production version?}_*
...
image::ROOT:SLN-GKSYS/RV-GKSYS-FIG-206_OVStreamSetup.png[image,400]

Follow the same steps as for the <<s_LPR-Camera-Stream-Setup>>.
