...
for a *_\{single lane is correct? YES}_* single lane, to work with the {docproductname} {docproductname3} System.
...
*_\{is this necessary? NO NO SUCH APP}_* The minimum {docproductname} *_\{correct product name?}_* {docproductname3} version
required is *_\{is there such a version to put in here?}_*

======================

== Solution BOM
*_\{ONLY USA - is this list of models/countries still correct for GKSYS??}_*
...
* Third-party Software: *_\{DELETE: who provides this -
...
*_\{NO LOOP DETECTOR: are these pics correct or do they need changing?}_*
...
*_\{USE TIBA SCREEN BUT AT 30 AT TOP;
TRIG AND NO TRIG ARE ALWAYS 5 The LPR and OV Stream Setup screens did not have these
...
port. For example: *_\{installer get URL from
GKSYS - do not show it actually - show
a fake example}_*  +
...
** *_\{NO - MAKE ALL GENERIC WITH REUSE delete this?}_* +++<u>+++Triggered+++</u>+++ - Events are created and reported when a trigger is received
