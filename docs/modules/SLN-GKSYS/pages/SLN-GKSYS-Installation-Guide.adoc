...
*_\{Pinchas: there is not much
installation; how do you want this divided
into installation and user guides?}_*
...
=== {software-cloud} Access Lists - Whitelists and Blacklists

Access Lists provide Access Control capaabilities.
They are lists of plates which can be matched to
when a vehicle arrives at the site (whitelists and blacklists).
