...
*_\{need new screen shot showing disabled}_*
...
*_\{need new image showing disabled/zero}_*
...
*_\{are these regions relevant for GKSYS?}_*
...
*_\{need new screen shot for GKSYS - currently
only shows upper section with basic info -
may be due to the same bug preventing us
from seeing the System Tab's parameters}_*
...
*_\{need new screen shot - was not available}_*
