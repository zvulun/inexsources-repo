...
* Third-party Software: *_\{who provides this -
"your system administrator"? Inex?}_*
** Cisco Meraki Account
** Cisco AnyConnect (provides VPN access to the cameras)
...
image::ROOT:SLN-GKSYS/RV-GKSYS-FIG-202_SecureClientLogin.png[image,300,align=center]

. Enter the username and password you
received from your system administrator.
