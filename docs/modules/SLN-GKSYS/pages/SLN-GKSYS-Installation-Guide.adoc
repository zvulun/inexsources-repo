...
but what is the correct FPS - 5 or 10? do we have
to tell user what to do in Triggered Mode?}_*
...
*_\{do we have to tell what to do in Triggered Mode -
GKSYS is a non-triggered project?}_*
