...
image::ROOT:SLN-GKSYS/GKSYS-LOGO.png[image,150,align=left]
...
*_\{is this necessary?}_* The minimum {docproductname} *_\{correct product name?}_* {docproductname3} version
required is *_\{is there such a version to put in here?}_*

======================

== Solution BOM *_\{is this list of models/countries still correct for GKSYS??}_*
* Camera System:
...
* *_\{is IZCloud relevant?}_* IZCLOUD-APM - {software-cloud} Automatic License Plate Recognition (ALPR) Performance Monitoring
...
are on the unit's sticker, typically: Processor ({ip-default-IZA-DPU}), LPR ({ip-default-IZA-LPR})
