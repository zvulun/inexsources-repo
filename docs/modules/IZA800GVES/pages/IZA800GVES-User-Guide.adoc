...
see <<s_Related-Documents>> and <<s_Specifications>>.
...
When using {compname-short} cables (such as the IZ Composite Cable or the prefabricated Power/LAN Cable), for proper LAN connectivity from the camera via the {hw-connection-panel}, the maximum cable length is 200 feet.
