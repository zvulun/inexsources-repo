...
If you have built the Power/LAN Cable using the IZ_COMPOSITE_CABLE, or if you need to remove more insulation from the IZCAB-AVES Power/LAN cable, follow these instructions:
