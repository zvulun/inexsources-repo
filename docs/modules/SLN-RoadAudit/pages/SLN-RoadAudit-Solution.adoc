...
* [*] Time-synchronized correlation of the in-lane
production transaction data with the DVAS video stream
...
.^a| {software-ALPR} external data processing server
...
The cameras use 24 VDC; the entire system
requires no more than 400W of power
...
[discrete]
== {software-ALPR} Video and ALPR Cameras Specifications
...
[discrete]
== {software-ALPR} and DVAS External Processing Servers Specifications
