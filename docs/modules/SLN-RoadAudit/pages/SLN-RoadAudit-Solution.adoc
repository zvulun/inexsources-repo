...
^.^a| image:ROOT:SLN-RoadAudit/RoadAudit-FIG-006_WP_DVAS_Server.png[image,width=60]

.^a| {software-ALPR} Video Camera and {software-ALPR} ALPR camera illuminators
.^a| image:ROOT:SLN-RoadAudit/RoadAudit-FIG-007_WP_RV_ALPR_Illuminators.png[image,width=70]
