...
according to the camera's location (defined
...
*** *Latitude* - latitude coordinate of camera's location

*** *Longitude* - longitude coordinate of camera's location
...
. Select a camera from the dropdown list *_\{Max: always View?}_* (LPR or OV).
...
* *_\{Zvulun mention system status tab and make screen shot}_*
