...
== Configuring/Controlling Parameters via the GUI and API
...
image::ROOT:RoadViewALPR/RV-1_15-FIG-021b_3_Line_ChangePW.png[image,width=110]
...
image::ROOT:RoadViewALPR/RV-1_15-FIG-020a_Logging_Out.png[image,width=110]
...
* Note that you can add/remove different columns to/from
the Live and Search tabs by selecting "Configure Journal"
from the multi-line menu at the upper right of the screen
(see <<f_Change-Password-Multi-line-Menu>>)
