...
** *Type* - Type of camera *_\{Max: Always View?}_* (LPR or View)

** *Video Recording Enabled* - Check the box to
enable video recording

** *Video Pre Time* - *_\{Max what is this}_*
Set as shown

** *Video Post Time* - *_\{Max what is this}_*
Set as shown
...
* *{docproductname3} URL* - *_\{Max - any tips for entering like
DO NOT enter the addition for the full path?}_*

* *{docproductname3} User Name* - username to access the {docproductname3} server

* *{docproductname3} Password* - BasicAuth password to access the {docproductname3} server

* *Camera Port* - Not required, leave at default, for future
expansion - *_\{Max - correct?}_*
the HTTPS port on which {software-ALPR}
listens for capture and “open gate” commands

* *Log Store Days* - *_\{Max?}_*

* *Keep Alive Interval* - *_\{Max?}_*

* *Offline Enabled* - *_\{Max?}_*
...
*_\{Max/Pinchas - do we have to tell them to set this?}_*

[#f_Offline-Queue-Section]

.Offline Queue Section

image::ROOT:SLN-PTL/RV-PTL-FIG-008_Offline_Queue.png[image,500]

[#s_Journal]

=== Journal

*_\{Zvulun tell users to enable journal; Max: use defaults?}_*
