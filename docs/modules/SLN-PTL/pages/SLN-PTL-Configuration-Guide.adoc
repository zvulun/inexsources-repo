...
specific dates. Enables "enforcement" (Event processing)
...
"Enforcement" means processing of Events, and sending
records to the server. |yes |no |RV config file |"startEnforceNow" in API
...
vehicles not on the White List (a "violation").
