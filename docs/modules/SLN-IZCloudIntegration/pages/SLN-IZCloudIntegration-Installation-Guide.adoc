...
|===
|Doc. No. |Title
.^|xref:RoadViewALPR:DocList.adoc[RV-ALPR-MAN-001] |RoadView ALPR User Guide
...
{software-cloud} subscription. {compname-short}
...
set the parameters according to instructions
from {compname-short}. +
+
...
Doc. No. RV-{shortprodname}-MAN-002b Ver. {docdate}
