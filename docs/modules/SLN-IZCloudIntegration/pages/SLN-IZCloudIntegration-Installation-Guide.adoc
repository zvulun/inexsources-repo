...
[discrete]
== Purchasing an IZCloud Subscription
...
the {software-cloud} Integration in RoadView
...
image::ROOT:SLN-IZCloudIntegration/RV-1_15-FIG-214F_FULLNewIZCloudIntegration.png[image,550]
...
* *Push Video to Server* - When enabled, RoadView
...
* *Keep-Alive Enabled* - *_\{what is this?}_*

** *Keep-Alive Interval* - *_\{what is this?}_*

** *Keep-Alive Fail Count* - *_\{what is this}_*

** *Get Access List Timeout* - *_\{what is this?}_*
