...
.^|xref:IZREMRELAY:DocList.adoc[{hw-webrelay-quad} Datasheet]
.^|xref:IZREMRELAY:DocList.adoc[{hw-webrelay-quad} Quad-Relay Remote (WEB) Relay: Supporting Documentation]
|===
