...
[discrete]
== Power/Signals Cable for {camera-ORT} System
...
* [*] Designed for an {compname-short} {camera-ORT} System
...
|{shortprodname}-15F |Power/Signals Cable for {camera-ORT} System, 15 ft
|===
