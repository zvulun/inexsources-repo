...
*_\{need new picture here and in SalesForce}_*

image:ROOT:IZIDPUGOX/IZIDPUGOX-Front-Page.png[Picture of DPU,400,align=left]
...
.^|IZIDPUGOX-128G .^|{generic-product-name} with 128 GB storage
.^|IZIDPUGOX-256G .^|{generic-product-name} with 256 GB storage
.^|IZIDPUGOX-512G .^|{generic-product-name} with 512 GB storage
.^|IZIDPUGOX-1T .^|{generic-product-name} with 1 TB storage
|===
...
*_\{need new pictures}_*

[discrete]
== Dimensions

image::ROOT:IZIDPUGOX/IZIDPUGOX-Dimensions2b.png[image,500]

[discrete]
== Typical System Diagram

image::ROOT:IZIDPUGOX/IZIDPUGOX-System-Diagram2.png[image,width=800,align=left]
