...
.^|{shortprodname}-128G-DC .^|{generic-product-name} with 128 GB storage; DC cable only
.^|{shortprodname}-256G-DC .^|{generic-product-name} with 256 GB storage; DC cable only
.^|{shortprodname}-512G-DC .^|{generic-product-name} with 512 GB storage; DC cable only
.^|{shortprodname}-1T-DC .^|{generic-product-name} with 1 TB storage; DC cable only
