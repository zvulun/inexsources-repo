...
.^|{shortprodname}-128G-DC .^|{generic-product-name} with 128 GB storage; +
DC cable only
.^|{shortprodname}-256G-DC .^|{generic-product-name} with 256 GB storage; +
DC cable only
.^|{shortprodname}-512G-DC .^|{generic-product-name} with 512 GB storage; +
DC cable only
.^|{shortprodname}-1T-DC .^|{generic-product-name} with 1 TB storage; +
DC cable only
.^|{shortprodname}-1T-EU .^|{generic-product-name} with 1 TB storage; +
12 VDC power supply with Hybrid CEE 7/7 (IEC TR60083 Type F) plug
.^|{shortprodname}-1T-IL .^|{generic-product-name} with 1 TB storage; +
12 VDC power supply with SI 32 (IEC TR60083 Type H) plug
.^|{shortprodname}-1T-UK .^|{generic-product-name} with 1 TB storage; +
12 VDC power supply with BS 546 (IEC TR60083 Type D) plug
.^|{shortprodname}-1T-US .^|{generic-product-name} with 1 TB storage; +
12 VDC power supply with NEMA 5-15 (IEC TR60083 Type B) plug
|===
...
* 12 VDC Power Supply (except as noted in Ordering Information)
