...
.^|{shortprodname}-1T .^|{generic-product-name} with 1 TB storage; DC cable only
.^|{shortprodname}-1T-US .^|{generic-product-name} with 1 TB storage; 12 VDC power supply with US-compatible plug
.^|{shortprodname}-1T-IL .^|{generic-product-name} with 1 TB storage; 12 VDC power supply with Israel-compatible plug
.^|{shortprodname}-1T-EU .^|{generic-product-name} with 1 TB storage; 12 VDC power supply with European-compatible plug
|===
