...
========================================
When opening or closing the housing's
captive screws, turn the screws
ALTERNATELY, a little at a time -
DO NOT open/close one screw completely.
This places an extreme angle between
the captive screws, and may cause paint
to crack around the screw holes,
increasing the likelihood of corrosion.
