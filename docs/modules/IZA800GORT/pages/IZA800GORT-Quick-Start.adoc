...
image::ROOT:IZA800GORT/IZA800GORT-FIG-034f_USA_IllumLPRFront.png[image,width=530]
...
image::ROOT:IZA800GORT/IZA800GORT-FIG-034g_USA_CamOnlyWiring.png[image,width=428]
