...
* [*] Flexible power input options - 24 VDC, or 24/48 VDC and PoE{plus}
...
include::ROOT:partial$IZA500GR/p-IZA500GR-spec-tbl-end-power-accessories.adoc[IZA500GR Specification Table End Power and Accessories]
...
|{shortprodname}-DR |5-40 ft (1.5-12 m) range, Deep Red illumination, 24 VDC input voltage
|{shortprodname}-DR-P24 |5-40 ft (1.5-12 m) range, Deep Red illumination, PoE{plus}, 24 VDC input voltage
|{shortprodname}-DR-P48 |5-40 ft (1.5-12 m) range, Deep Red illumination, PoE{plus}, 48 VDC input voltage
|{shortprodname}-DRW |5-40 ft (1.5-12 m) range, Deep Red and Visible Light illumination, 24 VDC input voltage
|{shortprodname}-DRW-P24 |5-40 ft (1.5-12 m) range, Deep Red and Visible Light illumination, PoE{plus}, 24 VDC input voltage
|{shortprodname}-DRW-P48 |5-40 ft (1.5-12 m) range, Deep Red and Visible Light illumination, PoE{plus}, 48 VDC input voltage
|{shortprodname}-IR |5-40 ft (1.5-12 m) range, Infrared illumination, 24 VDC input voltage
|{shortprodname}-IR-P24 |5-40 ft (1.5-12 m) range, Infrared illumination, PoE{plus}, 24 VDC input voltage
|{shortprodname}-IR-P48 |5-40 ft (1.5-12 m) range, Infrared illumination, PoE{plus}, 48 VDC input voltage
|{shortprodname}-IRW |5-40 ft (1.5-12 m) range, Infrared and Visible Light illumination, 24 VDC input voltage
|{shortprodname}-IRW-P24 |5-40 ft (1.5-12 m) range, Infrared and Visible Light illumination, PoE{plus}, 24 VDC input voltage
|{shortprodname}-IRW-P48 |5-40 ft (1.5-12 m) range, Infrared and Visible Light illumination, PoE{plus}, 48 VDC input voltage
|===
...
image::ROOT:IZA500G/IZA500G-FIG-085f1_With_P2448VDC_Option.png[image,width=542,height=370]
