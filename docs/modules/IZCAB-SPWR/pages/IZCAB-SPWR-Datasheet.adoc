...
image:IZCAB-SPWR:IZCABSPWR-FIG-001_Front_Page.png[Picture of Cable,width=800,align=left]
...
|===
.^a|image:IZCAB-SPWR:IZCABSPWR-FIG-002_Pinouts.png[image,width=400]
|[table.withborders,width="100%",cols="10%,55%,35%",options="header",]
!===
!Pin !Power/Signal !Wire Color
!1 !DC12-24V input !Red
!2 !Power GND !Black
