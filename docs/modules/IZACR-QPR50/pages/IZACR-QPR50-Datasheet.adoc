...
image::ROOT:IZACR-QPR50/IZACR-QPR50-Dimensions.png[image,width=400,align=left]
...
image::ROOT:IZACR-QPR50/IZACR-QPR50-Patch-Cable-Colored-Leads.png[image,width=390,align=left]
