...
* [*] Flexible connectivity - LAN or WiFi

* [*] Integrated with {software-cloud} for comprehensive monitoring

* [*] Anti-vandal housing for efficient, worry-free operation

* [*] Wide temperature range - operating from -22°F to 158°F (-30°C to 70°C)

* [*] IP65 ingress protection against moisture and dust

*_\{Assuming that this product has these certifications?
what about anti-vandal? RoHS - catalog claims
RoHS but can't see certificate?}_*
...
.^|IZACP-2D .^|Two-door Access Control Panel
.^|IZACA-MCPS .^|Metal case with power supply for {compname-short} access control panels
.^|IZAC-QPR-1D .^|Single Door Access Bundle (includes reader, control panel and case)
*_\{if panel can accommodate 2 doors, why is bundle for only one door?}_*
|===
...
*_\{dimensions taken from catalog}_*
