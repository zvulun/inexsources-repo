...
*_\{Turn this into 2 partials, here
and in JLT - before
and after second screen - so second screen
can have different IP addresses}_*
...
*_\{need to fix legal disclaimer - has reference to
related docs as Asciidoc link at end}_*
