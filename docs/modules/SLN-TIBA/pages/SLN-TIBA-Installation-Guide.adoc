...
*_\{Pinchas: What did customer mean by:
The token (GUID) I previously sent is only
supported starting with this version,
which is a crucial detail to highlight.}_*
...
as defined in the TIBA LPR settings. For example: +
...
Set the Direct Trigger as follows:
