...
Click on your user name at the upper-right of the screen,
...
The Events page enables you to view live Events.
...
to find within the names }_*

=== {software-cloud} Maintenance - Cameras

*_\{enables you to do what?}_*
...
The Dashboard page enables you to *_\{do what?}_*
...
The Lanes page enables you to view live video
and *_\{what}_*.
