...
[IMPORTANT]
==================
*Change [.underline]#only# these settings, and remember to
...
image::ROOT:SLN-TIBA/IZA500G-FIG-093_AmanoLPRVideoStreams.png[image,800]
...
image::ROOT:SLN-TIBA/IZA500G-FIG-094_AmanoLPRCameraSettings.png[image,800]
