...
* For Front Capture - +++<u>+++OnRise+++</u>+++

* For Rear Capture - +++<u>+++OnFall+++</u>+++
...
image::ROOT:SLN-TIBA/RV-TIBA-FIG-008aUS_SystemInfo.png[image,500]

include::ROOT:partial$SLN-GKSYS/p-GKSYS-system-info-frequent-parms.adoc[]
...
image::ROOT:SLN-TIBA/RV-TIBA-FIG-011aUS_CalibrationTab.png[image,800]

include::ROOT:partial$SLN-GKSYS/p-GKSYS-calibration-tab-text.adoc[]

[#s_Verify-System-Operation]

== Verify System Operation

include::ROOT:partial$SLN-GKSYS/p-GKSYS-start-verify-operation.adoc[]

.Live (Journal) Tab

image::ROOT:SLN-TIBA/RV-TIBA-FIG-009aUS_LiveTab.png[image,800]

include::ROOT:partial$SLN-GKSYS/p-GKSYS-end-verify-operation.adoc[]
...
include::ROOT:partial$SLN-GKSYS/p-GKSYS-RV-troubleshooting.adoc[]
