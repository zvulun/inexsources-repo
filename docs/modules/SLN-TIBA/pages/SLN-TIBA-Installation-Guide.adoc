...
*_\{take pic of login screen;
In lanes screen, }_*

image::ROOT:SLN-TIBA/IZCloud-BorderTIBA-Events.png[image,800]

*_\{use text from SF; tell you have to configure in RV
then you can log in and see IZCloud screen shots
Read Rate = with no read mistakes
Read Rate N-1 = with up to 1 read mistake
Read Rate N-1 = with up to 2 read mistakes
Actions in the Maintenacne> camera screen:
Last Review
...
* Click inside  time stamp filter
box to display a calendar popup.
You can select
** a specific date, or +
...
** a range by clicking on a
start date, then clicking on
an end date +

.{software-cloud}: Selecting a Data Range

image::ROOT:SLN-TIBA/IZCloud-BorderSelect-Date-Range.png[image,300]
