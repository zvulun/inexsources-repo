...
*_\{make table of distances and coverage
take FOV, Max Speed and LPR capture distance
from data sheet spec table into small
table
}_*
...
length 328 ft (100 m), OD *_\{6-12 mm; ask Dima; we use 7.2 mm}_* *
.^|Supplied by integrator; 6.6 ft (2 m) included with camera
.^|C .^a|*PAS (Power and Signals) Cable -  22-26 AWG, OD *_\{5-10 mm; ask Dima 6.2}_* * .^|Supplied by integrator; 6.6 ft (2 m) cable included with camera
.^|D .^a|*Power Supply 48 VDC*
.^a|
For 1 camera, use a 75 W supply (*_\{add this model to the data sheet/
SF}_*IZPWR75-48) +
...
*_\{take new screen shots of same 4 groups;
but comes preconfigured}_*
...
image::ROOT:SLN-TIBA/IZCLOUD-TIBA-Events.png[image,800]
