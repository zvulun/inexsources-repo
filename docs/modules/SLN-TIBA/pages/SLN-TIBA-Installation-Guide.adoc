...
image::ROOT:SLN-TIBA/IZCloud-BorderTIBA-Logout.png[image,400]
...
to display the Last Review page, filtered for
...
with confidence below an acceptable
threshold *_\{where is this set?}_*
