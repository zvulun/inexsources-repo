...
|===
|Doc. No. |Title
//.^|xref:IZA500G:DocList.adoc[{fileproductname}-MAN-002b] |{fileproductname} Installation Guide
.^|https://drive.google.com/drive/folders/1oi7em94DgmiI9FC4h9iM_3BrjlgxvUYU?usp=share_link[{fileproductname}-MAN-002b,window=_blank] |{fileproductname2} Installation Guide

//.^|xref:IZA500G:DocList.adoc[{fileproductname}-MAN-002a] |{fileproductname} User Guide
.^|https://drive.google.com/drive/folders/1oi7em94DgmiI9FC4h9iM_3BrjlgxvUYU?usp=share_link[{fileproductname}-MAN-002a,window=_blank] |{fileproductname2} User Guide
...
Doc. No. {shortprodname2}-MAN-002b
