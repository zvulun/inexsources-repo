...
*_\{just mention Chrome and Edge;
comment out this configuration section}_*
...
is *_\{withing the extent of the vertices}_* 150 pixels, and its plate image is clear and sharp.
...
.{software-cloud} Integration - {software-ALPR} Settings Section
