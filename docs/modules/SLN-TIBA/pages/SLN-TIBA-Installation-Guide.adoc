...
.^|https://drive.google.com/drive/folders/1oi7em94DgmiI9FC4h9iM_3BrjlgxvUYU?usp=share_link[{shortprodname}-MAN-002a,window=_blank] |{shortprodname} User Guide
