...
*_\{do I need  note that the inductive loop
and loop detector is only for triggered mode (Israel)?}_*
...
*_\{all camera pictures need updating!!!}_*
...
*_\{I have used the TIBA-US screen here (non-triggered),
but what is the correct FPS - 5 or 10? }_*
...
//*_\{old text}_*
//.LPR Camera - Video &amp; Device &gt; Video Streams (Triggered Mode)
...
image::ROOT:SLN-TIBA/RV-TIBA-FIG-016_US_LPRCameraSetup.png[image,400]
...
*_\{what to tell user for triggered mode - 5 fps?}_*

//.OV Camera - Video &amp; Device &gt; Video Streams (Triggered Mode)
//image::ROOT:SLN-TIBA/IZA500G-FIG-111_TIBAOVVideoStreams.png[image,400]

==== Non-triggered Mode

For Non-triggered mode, set the primary stream frame rate
to 10 fps. *_\{need to change picture to show 10 fps?}_*
...
image::ROOT:SLN-TIBA/RV-TIBA-FIG-019_US_OVCameraSetup.png[image,400]
...
.Software Version and Camera Information Section - U.S.
...
.Date and Time Settings Section - U.S.
