...
image::ROOT:SLN-TIBA/RV-TIBA-FIG-003c_TriggerOffsetIllustrated.png[image,800]
...
according to the Camera System's location (as defined
by the Latitude and Longitude parameters). For the Auto mode, additional parameters appear:
+
[NOTE]
