...
*_\{
Last Review
Plate = Plate read; Plate REview = True read
...
*_\{Click license plate to
see images of plate and ov in a separate
window - in both lanes and Events screens}_*
...
* *Read Status* - *_\{need to describe all the read statuses
in the dropdown filter}_*
