...
onboard processor and LPR/OV sensors, and to
...
=== LPR Sensor - Video &amp; Device &gt; Video Streams &gt; Camera Settings
...
=== LPR Sensor - Video &amp; Device &gt; Video Streams &gt; Primary Stream
...
=== LPR Sensor - System &gt; Access Level

.LPR Sensor - System &gt; Access Level

image::ROOT:SLN-TIBA/IZA500G-FIG-116_TIBALPRAccessLevel.png[image,600]

== Configure the OV Camera

Change the parameters to match the following screen captures:

=== OV Sensor - Video &amp; Device &gt; Video Streams
...
=== OV Sensor - Video &amp; Device &gt; Video Streams &gt; Camera Settings
...
=== OV Sensor - Video &amp; Device &gt; Video Streams &gt; Primary Stream
