...
reinstallation of the IZ ALPR system, or when some
fundamental parameters need updating.
For example, if the Camera System or DPU was moved
...
image::ROOT:SLN-TIBA/RV-TIBA-FIG-001aa_VersionAndCameraInfo.png[image,400]

image::ROOT:SLN-TIBA/RV-TIBA-FIG-001bb_Network.png[image,600]
