...
include::ROOT:partial$IZA500G/p-IZA500G-spec-table.adoc[IZA500G Specification Table]

[#t_IZA500GR-Technical-Specifications]

.{shortprodname2} Technical Specifications

include::ROOT:partial$IZA500GR/p-IZA500GR-spec-table.adoc[IZA500GR Specification Table]
