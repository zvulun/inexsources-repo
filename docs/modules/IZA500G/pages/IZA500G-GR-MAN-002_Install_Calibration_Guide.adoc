...
* Gather any additional items needed - see <<s_Required-Accessories-Not-Included>>.

* Plan your physical installation - see <<s_Planning-Your-Installation>>.

* Install the hardware - see <<s_Hardware-Installation>>.
...
image::./UserGuide/image5.png[image,width=321,height=215]

image::./UserGuide/image6.png[image,width=465,height=224]
...
The {shortprodname}'s illuminators project different light intensities in a sequence (also called multi-flash technology). This produces a series of video frames with varying degrees of illumination, which helps to determine the best possible recognition.
...
[#f_IZA500G-GR-White-LED-Positions]
...
* Not installing camera in east/west direction

* Installing camera near a building that shields it from the sun's rays

* Installing camera on a short pole
...
*The {compname-short} {docproductname} Camera Systems are typically used with {illum-non-strobe} series illuminators.*

By using the following guidelines, you can match the illuminator you need to the {compname-short} Camera System being used.

* The number of illuminator LEDs and beam angle must match the distance rating of the Camera System being used, as follows:
