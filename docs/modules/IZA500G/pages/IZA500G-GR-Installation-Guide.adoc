...
You may need to add extensions to the built-in cables. Be sure that there is enough signal and power strength at the components at the end of the extensions.
