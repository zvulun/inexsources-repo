...
|{shortprodname}-S-DRW |Captures at 5-35 ft (2-11 m), Deep Red &amp; Visible Light illumination, 24 VDC input voltage
|{shortprodname}-S-DRW-P48 |Captures at 5-35 ft (2-11 m), Deep Red &amp; Visible Light illumination, PoE{plus}, 48 VDC input voltage
|{shortprodname}-S-IR |
