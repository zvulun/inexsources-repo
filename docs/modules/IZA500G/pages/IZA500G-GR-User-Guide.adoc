...
.^|xref:IZxPOE:DocList.adoc[{hw-poeinjector}-DIN-REV-xxx-TDSHEET] |{hw-poeinjector} Gigabit 4-Port PoE++ Injector Technical Data Sheet
...
|PoE{plus}{plus} Injector | Required for P24/P48 models when using PoE+ power input
