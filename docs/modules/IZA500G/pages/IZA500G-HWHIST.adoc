...
* New power input option of PoE{plus} (for new P48 models; requires {hw-poeinjector} Gigabit PoE{plus}{plus} Injector)

* LPR Capture Distance changed from 5-70 ft (1.5-21 m) to: +
S - Short distance, 5-35 ft (1.5-11 m) +
...
Doc. No. {shortprodname}-HWHIST Ver. {docdate}
