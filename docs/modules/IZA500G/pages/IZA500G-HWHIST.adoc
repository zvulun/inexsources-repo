...
Hardware revision histories (HRH) inform our customers about changes being made to our {compname-long} products, such as physical appearance, hardware improvements, changes to package contents, part number changes, etc. Firmware changes are not included.
...
|Part No. {shortprodname}-XS-770 |--- a|
* Direct trigger input added
...
|Part No. {shortprodname}-XS-770 |--- |Internal hardware change
|Part No. {shortprodname}-XS-850 | |
|Part No. {shortprodname}-S-770 | |
|Part No. {shortprodname}-S-850 | |
|===
...
|Part No. {shortprodname}-XS-770 |Lithium battery |Super capacitor
|Part No. {shortprodname}-XS-850 | |
|Part No. {shortprodname}-S-770 | |
|Part No. {shortprodname}-S-850 | |
|===
